        ...
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          >
            <div className="md:w-1/2">
              ...
              >
                <span className="text-gold uppercase tracking-[0.15em] text-xs font-medium mb-3 block">
                  Since 2015
                </span>
                <h2 className="text-4xl md:text-5xl font-medium text-deep mb-6 font-serif leading-tight">
                  The Beginning
                </h2>
                <div className="w-20 h-[2px] bg-gold mb-8" />
                <p className="text-neutral-600 mb-6 leading-relaxed text-base font-light">
                  Founded in 2018, Little Paris started with a simple dream: to
                  bring the authentic taste of French cuisine to the heart of
                  Addis Ababa. What began as a small bistro has grown into one
                  of the city's most beloved dining destinations.
                </p>
                <p className="text-neutral-600 leading-relaxed text-base font-light">
                  ...
                  ingredients are locally sourced where possible, blending the
                  freshness of Ethiopian produce with classic French cooking
                  techniques.
                </p>
              </motion.div>
            </div>
            ...
            >
              <div className="relative h-[450px] group">
                ...
                <div
                  className="relative h-full rounded-2xl overflow-hidden shadow-2xl transform rotate-2 group-hover:rotate-0 transition-all duration-700 group-hover:shadow-[0_25px_60px_-15px_rgba(0,0,0,0.5)] group-hover:scale-105 group-hover:-translate-y-2"
                ...
                >
                  ...
                  <div
                    className="absolute inset-0 bg-gradient-to-tr from-transparent via-white/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-700 transform -translate-x-full group-hover:translate-x-full"
                    style={{
          ...
          >
            <div className="md:w-1/2">
              ...
              >
                ...
                <h2 className="text-4xl md:text-5xl font-medium text-deep mb-6 font-serif leading-tight">
                  Meet the ChefFounded in 2018
                </h2>
                <div className="w-20 h-[2px] bg-gold mb-8" />
                <p className="text-neutral-600 mb-6 leading-relaxed text-base font-light">
                  Chef Jean-Pierre, with over 20 years of experience in Paris
                  and Lyon, leads our kitchen with passion and precision. His
                  philosophy is simple: respect the ingredients and cook with
                  love.
                </p>
                <blockquote className="relative pl-6 border-l-2 border-gold">
                  <p className="text-neutral-700 leading-relaxed text-base italic font-light">
                    "Cooking is an art, but it is also a language. At Little
                    Paris, we speak the language of flavor."
                  </p>
                  <cite className="text-gold text-sm font-medium not-italic block mt-3">
                    — Chef Jean-Pierre
                  </cite>
                </blockquote>
              </motion.div>
      ...
      <section className="py-20 bg-white/50">
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-medium text-deep mb-6 font-serif">
              What We Stand For
            </h2>
            ...
            {[
              {
                title: "Quality",
                description:
                  "We source only the finest ingredients, ensuring every dish meets our exacting standards.",
                icon: "✨",
              },
              {
                title: "Authenticity",
                description:
                  "Traditional French techniques combined with local Ethiopian flavors create unique experiences.",
                icon: "🎯",
              },
              {
                title: "Passion",
                description:
                  "Every meal is prepared with love and dedication by our talented culinary team.",
                icon: "❤️",
              },
            ].map((value, index) => (
              <motion.div
              ...
              >
                ...
                <h3 className="text-2xl font-medium text-deep mb-4 font-serif group-hover:text-gold transition-colors duration-300">
                  {value.title}
                </h3>
